...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  final number1 = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    final firstField = TextFormField(
      ...
      style:
          TextStyle(color: Colors.black, fontSize: 20, fontFamily: 'Poppins'),
      ...
      validator: (value) {
        ...
        if (!regex.hasMatch(value)) {
          return ("please enter valid name (min 4 character");
        }
        return null;
      },
      onSaved: (value) {
    ...
    final number = TextFormField(
      ...
      validator: (value) {
        ...
        if (!regex.hasMatch(value)) {
          return ("please enter valid mobile number (min 10 number) ");
        }
        return null;
      },
      onSaved: (value) {
